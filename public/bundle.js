...
var a = usuarios.map(function (_ref) {
  var idade = _ref.idade;
  return {
    idade: idade
  }.idade;
});
console.log(a); //Exercicio2.2

var trabalha = usuarios.filter(function (emp) {
  return emp.empresa === 'Rocketseat';
}); //Pode ser feito das duas maneiras

var trabalha = usuarios.filter(function (_ref2) {
  var empresa = _ref2.empresa;
  return empresa === 'Rocketseat';
});
console.log(trabalha); //Exercicio2.3

var procura = usuarios.find(function (user) {
  return usuarios.empresa === 'Google';
});
console.log(procura); //Exercicio2.4

var mult = usuarios.map(function (_ref3) {
  var usuarios = _extends({}, _ref3);
